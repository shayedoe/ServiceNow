...
const COLS = [
  ...
  'notes','caller_label','caller_id','subcategory','business_service','cmdb_ci',
...
function insertTicket(t) {
  ...
  `).run(
    ...
    t.tier || 1,
    t.priority == null ? null : Number(t.priority),
    t.impact == null ? null : Number(t.impact),
    t.urgency == null ? null : Number(t.urgency),
    ...
    t.caller_label || '', t.caller_id || '', t.subcategory || '', t.business_service || '', t.cmdb_ci || '',
